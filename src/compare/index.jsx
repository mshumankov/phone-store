...
const Error = () => {
    ...
    const choosePhone = (e, listStyle, getPhone, loadPhoneInfo) => {
        ...
        valueInput ? listStyle(true) : listStyle(false);
    }
            ...
            <section className='page-wrap'>
                <div className={style['section-wrap']}>
                    ...
                    <div className={style['compare-wrap']}>
                        <div className={style.category}></div>
                        <div className={style.data}>
                            <div className={style['image-name-wrap']} style={firstPhoneInfo.name || secondPhoneInfo.name || thirdPhoneInfo.name ? { display: 'block' } : { display: 'none' }}>
                            ...
                            <div className={style['image-name-wrap']} style={firstPhoneInfo.name || secondPhoneInfo.name || thirdPhoneInfo.name ? { display: 'block' } : { display: 'none' }}>
                                ...
                                <div>
                                    <img src={secondPhoneInfo.image} alt={secondPhoneInfo.name} />
                                </div>
                            </div>
                            <div className={style['image-name-wrap']} style={firstPhoneInfo.name || secondPhoneInfo.name || thirdPhoneInfo.name ? { display: 'block' } : { display: 'none' }}>
                                <div className={style['phone-hedding']}>
                                ...
                                <div>
                                    <img src={thirdPhoneInfo.image} alt={thirdPhoneInfo.name} />
                                </div>
                            </div>
                        </div>
                    </div>
